...
/**
 * This module exports the ServerURL for the current environment based on "process.env.NODE_ENV" variable that becomes set with the webpack DefineTextPlugin.
 * @type {string}
 */
